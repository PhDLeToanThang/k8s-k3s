## 1. Xây dựng cải tổ lại Labs và hosting dịch vụ của Doanh nghiệp theo hướng Merge các dịch vụ chạy chuẩn theo Linux vs Dockers + NGINX proxy:
##
## Prompts from the script:
##
## First, you'll be prompted to select the number for your OS / Distro. Currently I support:
## 1. CentOS 7 and 8, 
## 2. Debian 10 and 11, 
## 3. Ubuntu 18.04, 20.04, 21.04, and 21.10.
##
...
## 4. Navidrome (music player)
## 5. Speedtest (recurring internet speedtest)
## 6. Portainer-CE
...
##    Before prompting to install Docker or Docker-Compose, I do try to see if you already have them installed, 
##    and I skep the prompt if you do (or I try to anyway).
##    Recent changes
##    Removed a lot of the "screen spam" from stdout, and just provide step information for what is running.
##    Imrpoved the Debian 11 wait time for the Docker service to start up and be running.
##
## Future Work:
##
## 1.  Make it work for Raspberry Pi
## 2.  Make it work for Arch
## 3.  Make it work for OpenSuse
...
## Contributing:
##
## If you find issues, please let me know. I'm always open to new contributors helping me add Distro support, more software packages, etc. 
## Just clone the project and make a pull request with any changes you add. 
##
## Licensing:
##
## My script is offered without warranty against defect, and is free for you to use any way / time you want. 
## You may modify it in any way you see fit. Please see the individual project pages of the software packages for their licensing.
##########################################################################################################################
